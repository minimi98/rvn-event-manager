import {db,collection,doc,setDoc,getDoc,serverTimestamp,onSnapshot,query,orderBy} from "./firebase.js?v=10.9";
import {state,defaultSettings,defaultRoles,sortRoles} from "./state.js?v=10.9";
import {shell,pageView,attachForms} from "./views.js?v=10.9";
import {toast} from "./utils.js?v=10.9";
...
if("serviceWorker" in navigator){window.addEventListener("load",()=>navigator.serviceWorker.register("./service-worker.js?v=10.9",{updateViaCache:"none"}).then(r=>r.update()).catch(console.warn));}
