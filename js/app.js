import {db,collection,doc,setDoc,getDoc,serverTimestamp,onSnapshot,query,orderBy} from "./firebase.js?v=10.8";
import {state,defaultSettings,defaultRoles,sortRoles} from "./state.js?v=10.8";
import {shell,pageView,attachForms} from "./views.js?v=10.8";
import {toast} from "./utils.js?v=10.8";
...
if("serviceWorker" in navigator){window.addEventListener("load",()=>navigator.serviceWorker.register("./service-worker.js?v=10.8",{updateViaCache:"none"}).then(r=>r.update()).catch(console.warn));}
